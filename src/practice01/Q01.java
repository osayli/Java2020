...
Scanner scan =new Scanner(System.in);
        ...
        int serviceOfYear=scan.nextInt();
        System.out.println("Enter your salary");
        int salary=scan.nextInt();

if(serviceOfYear<0||salary<0){
    System.out.println("Please enter valid data...");

} else if (serviceOfYear>=0&&serviceOfYear<5) {
    System.out.println("You should work:"+(5-serviceOfYear)+ " year(s)");
}else{
